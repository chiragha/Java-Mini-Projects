...
public void Connect()
    ...
    private void initComponents() {
        ...
        txtcatname.setFont(new java.awt.Font("Segoe UI Emoji", 0, 14)); // NOI18N
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGap(27, 27, 27)
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(txtcatname, javax.swing.GroupLayout.DEFAULT_SIZE, 140, Short.MAX_VALUE)
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        try {
            ...
            if(k==1){
                ...
                JOptionPane.showMessageDialog(this, "Category not Deleted!! there is some ERROR!!");
            }
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        try {
            ...
            if(k==1){
                ...
                JOptionPane.showMessageDialog(this, "Category not Created!! there is some ERROR!!");
            }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        // TODO add your handling code here:
         ...
         int id = Integer.parseInt(model1.getValueAt(selectIndex, 0).toString());
         txtcatname.setText(model1.getValueAt(selectIndex, 1).toString());
         txtstatus.setSelectedItem(model1.getValueAt(selectIndex, 2).toString());
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        try {
            ...
            if(k==1){
                ...
                JOptionPane.showMessageDialog(this, "Category not Updated!! there is some ERROR!!");
            }
