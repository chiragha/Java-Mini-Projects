...
public void Connect()
 ...
 public void Publisher_Load(){
    ...
    private void initComponents() {
        ...
        txtpubname.setFont(new java.awt.Font("Segoe UI Emoji", 0, 14)); // NOI18N
        ...
        txtpubphone.setFont(new java.awt.Font("Segoe UI Emoji", 0, 14)); // NOI18N
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        txtpubname.setText(model1.getValueAt(selectIndex, 1).toString());
        txtpubaddress.setText(model1.getValueAt(selectIndex, 2).toString());
        txtpubphone.setText(model1.getValueAt(selectIndex, 3).toString());
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        try {
            ...
            if(k==1){
                JOptionPane.showMessageDialog(this, "Publisher Data Added");
                txtpubname.setText("");
                ...
                JOptionPane.showMessageDialog(this, "Publisher details not Created!! there is some ERROR!!");
            }
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        try {
            ...
            if(k==1){
                ...
                JOptionPane.showMessageDialog(this, "Publisher details not updated!! there is some ERROR!!");
            }
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        try {
            ...
            if(k==1){
                JOptionPane.showMessageDialog(this, "Publisher Data Deleted");
                txtpubname.setText("");
                txtpubaddress.setText("");
                txtpubphone.setText("");
                txtpubname.requestFocus();
                ...
                JOptionPane.showMessageDialog(this, "Publisher data not deleted!! there is some ERROR!!");
            }
