...
public void Connect()
 ...
 public void Author_Load(){
    ...
    private void initComponents() {
        ...
        txtauthaddress = new javax.swing.JTextArea();
        jLabel4 = new javax.swing.JLabel();
        txtauthphone = new javax.swing.JTextField();
        ...
        txtauthname.setFont(new java.awt.Font("Segoe UI Emoji", 0, 14)); // NOI18N
        ...
        txtauthaddress.setColumns(20);
        txtauthaddress.setRows(5);
        jScrollPane2.setViewportView(txtauthaddress);

        jLabel4.setFont(new java.awt.Font("Segoe UI Emoji", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Phone:");

        txtauthphone.setFont(new java.awt.Font("Segoe UI Emoji", 0, 14)); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtauthphone, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(33, 33, 33)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(add)
                    .addComponent(update))
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        txtauthname.setText(model1.getValueAt(selectIndex, 1).toString());
        txtauthaddress.setText(model1.getValueAt(selectIndex, 2).toString());
        txtauthphone.setText(model1.getValueAt(selectIndex, 3).toString());
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        // TODO add your handling code here:
        String name = txtauthname.getText();
        String address = txtauthaddress.getText();
        String phone = txtauthphone.getText();
        ...
        try {
            ...
            if(k==1){
                JOptionPane.showMessageDialog(this, "Author Data Added");
                txtauthname.setText("");
                txtauthaddress.setText("");
                txtauthphone.setText("");
                txtauthname.requestFocus();
                Author_Load();
            }else{
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        try {
            ...
            if(k==1){
                ...
                JOptionPane.showMessageDialog(this, "Author details not updated!! there is some ERROR!!");
            }
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        try {
            ...
            if(k==1){
                JOptionPane.showMessageDialog(this, "Author Data Deleted");
                 txtauthname.setText("");
                txtauthaddress.setText("");
                txtauthphone.setText("");
                txtauthname.requestFocus();
    ...
    private javax.swing.JTextArea txtauthaddress;
    private javax.swing.JTextField txtauthname;
    private javax.swing.JTextField txtauthphone;
