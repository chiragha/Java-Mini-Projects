...
public class Interface extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(box1.equals("Celsius")&&box2.equals("Fahrenheit")){
            ...
            double cTof = (double)(c*1.8+32);
            jTextField2.setText(String.valueOf(cTof));
        }
        //celsius to kelvin
        else if(box1.equals("Celsius")&&box2.equals("Kelvin")){
            double c = Double.parseDouble(jTextField1.getText());
              double cTok = (double)(c + 273.15 );
            jTextField2.setText(String.valueOf(cTok));
        ...
        //code for Fahrenheit to celsius
         ...
         if(box1.equals("Fahrenheit")&&box2.equals("Celsius")){
            ...
            double fToc = (double)((f - 32)*5/9);
            jTextField2.setText(String.valueOf(fToc));
            
            // Fahrenheit to Kelvin
        }else if(box1.equals("Fahrenheit")&&box2.equals("Kelvin")){
            double f = Double.parseDouble(jTextField1.getText());
             double fTok = (double)((f - 32)*5/9 + 273.15);
            jTextField2.setText(String.valueOf(fTok));
       ...
       if(box1.equals("Kelvin") && box2.equals("Celsius"))
       {
           ...
           double kToc = (double)(k-273.15);
           
           jTextField2.setText(String.valueOf(kToc));
       }
       ...
       else if(box1.equals("Kelvin") && box2.equals("Fahrenheit"))
       {
           ...
           double kTof = (double)(k - 273.15) * 9/5 +32;
           
           jTextField2.setText(String.valueOf(kTof));
       }
       //---------------------Kelvin TO Kelvin-----
